      ...
      <Container>
        <div className="flex flex-col md:flex-row items-center rounded-lg my-14 px-2 lg:px-0">
          ...
          <div className="w-full md:w-1/2 h-64 md:h-[447px] relative">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3689.5267489814395!2d90.3910207!3d23.8103!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjPCsDQ4JzM3LjEiTiA5MMKwMjMnMjtwLjJF!5e0!3m2!1sen!2sbd!4v1234567890"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
