...
import { usePostSupportContactMutation } from '@/redux/api/landingPageApi/LandingPageApi'
import { toast } from 'sonner'
import { FaSpinner } from 'react-icons/fa6'

function Contact() {
  const [postSupportContact, { isLoading }] = usePostSupportContactMutation();
  ...
  const onSubmit = async (data: any) => {
    try {
      const response = await postSupportContact(data).unwrap();
      ...
      <Container>
        <div className="flex flex-col md:flex-row items-center rounded-lg my-14 px-2 lg:px-0">
          ...
          <div className="w-full md:w-1/2 h-64 md:h-[447px] relative">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d83998.94722687619!2d2.2770198486714073!3d48.8588377391234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66e1f06e2b70f%3A0x40b82c3688c9460!2sParis%2C%20France!5e0!3m2!1sen!2sfr!4v1721245678901"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
          ...
          <div className="w-full md:w-1/2 p-8 lg:p-30 flex flex-col justify-center">
            ...
            <div className="space-y-4 mt-2">
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-[16px] text-[#636F85]">contact@dilico.com</p>
              </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 md:p-8">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Full Name */}
              <div>
                <label htmlFor="fullName" className="block text-[16px] font-medium text-[#2D2D2D] mb-2">
                  Your Name
                </label>
                <input
                  type="text"
                  ...
                  className={`hover:shadow-[0_0_10px_rgba(0,0,0,0.1)] w-full px-4 text-[16px] text-[#636F85] py-3 border border-[#D1D6DB] rounded-md focus:ring-1 focus:ring-purple-500 focus:border-transparent outline-none transition ${errors.fullName ? 'border-red-500' : 'border-gray-300'}`}
                />
                {errors.fullName && (
              ...
              {/* Email */}
              <div>
                <label htmlFor="email" className="block text-[16px] font-medium text-[#2D2D2D] mb-2">
                  Your Email
                </label>
                <input
                  type="email"
            ...
            {/* Subject */}
            <div>
              <label htmlFor="subject" className="block text-[16px] font-medium text-[#2D2D2D] mb-2">
                Subject
              </label>
              <input
                type="text"
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading}
                className="p-3 bg-primaryBgColor hover:bg-bg-primaryBgColor text-[#FFFFFF] font-medium rounded-[6px] transition duration-200 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
