...
//     const {champion, decision_criteria, decision_process, economic_buyer, identify_pain, metrics} = getSummery?.data?.analytics?.meddic || {};
//     console.log(getSummery?.data?.analytics?.meddic, "==========getSummery")
