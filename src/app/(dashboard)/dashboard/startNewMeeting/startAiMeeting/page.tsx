...
export default function StartAiMeeting() {
    ...
    const [audioLevels, setAudioLevels] = useState([40, 60, 80, 70, 90, 60, 75, 85, 65, 70, 80, 60, 75]);
    ...
    return (
        <div className="flex flex-col items-center justify-center py-6">
            {/* Main Meeting Area */}
            <div className="w-full bg-[#EAEAEA] border-2 border-white rounded-lg mb-6 relative" style={{ height: '500px' }}>
                {/* Audio Visualization */}
