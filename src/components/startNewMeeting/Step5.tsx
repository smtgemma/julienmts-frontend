...
//                         <p className={`font-bold text-sm ${speaking ? "text-purple-700" : "text-[#2D2D2D]"}`}>
//                           {rep.name.toUpperCase()}
//                         </p>
//                         <p className="text-xs font-medium text-[#636F85]">{rep.role.toUpperCase()}</p>
//                         <p className="text-[10px] text-[#a0aec0]">{personalityStr}</p>
//                         {/* Gender badge */}
