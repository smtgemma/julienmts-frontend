...
//                   if (msg.type === 'system') {
//                     return (
//                       <div key={msg.id} className="flex justify-center animate-[fadeIn_0.3s_ease-in]">
//                         <div className="bg-gray-200 text-gray-600 text-xs px-4 py-2 rounded-full max-w-[80%] text-center">
//                           ℹ️ {msg.text}
...
//                   if (msg.type === 'user') {
//                     return (
//                       <div key={msg.id} className="flex justify-end animate-[fadeIn_0.3s_ease-in]">
//                         <div className="max-w-[75%] flex flex-col items-end">
//                           <div className="flex items-center gap-2 mb-1">
//                             <span className="text-xs font-semibold text-[#6E51E0]">{msg.speaker}</span>
//                             <span className="w-7 h-7 rounded-full bg-[#6E51E0] flex items-center justify-center text-white text-xs flex-shrink-0">🧑‍💼</span>
//                           </div>
//                           <div className="bg-[#6E51E0] text-white px-4 py-3 rounded-2xl rounded-tr-md shadow-sm text-sm leading-relaxed">
//                             {msg.text}
//                           </div>
...
//                   const isSecondary = msg.type === 'ai-secondary';
//                   return (
//                     <div key={msg.id} className="flex justify-start animate-[fadeIn_0.3s_ease-in]">
//                       <div className="max-w-[75%] flex flex-col items-start">
//                         <div className="flex items-center gap-2 mb-1">
//                           <span className={`w-7 h-7 rounded-full flex items-center justify-center text-white text-xs flex-shrink-0 ${isSecondary ? 'bg-orange-500' : 'bg-emerald-600'
//                             }`}>🤖</span>
//                           <span className={`text-xs font-semibold ${isSecondary ? 'text-orange-600' : 'text-emerald-700'
//                             }`}>{msg.speaker}</span>
//                         </div>
//                         <div className={`px-4 py-3 rounded-2xl rounded-tl-md shadow-sm text-sm leading-relaxed ${isSecondary
